...
if (!yorichi) {
    ...
    try {
        ...
        const response = await fetch('https://raw.githubusercontent.com/SungReved/games/refs/heads/main/Src/%D9%87%D8%A7%D8%B1%D9%8A.json');
...
handler.help = ['شخصية']; handler.tags = ['game']; handler.command = /^(هاري|هاري|answer_\d+)$/i;
