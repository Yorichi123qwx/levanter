...
if (!yorichi) {
    ...
    try {
        ...
        const response = await fetch('https://raw.githubusercontent.com/Yorichi123qwx/Yorichi-game/refs/heads/main/%D8%B9%D9%84%D9%85.js');
...
handler.help = ['شخصية']; handler.tags = ['game']; handler.command = /^(علم|answer_\d+)$/i;
