...
if (!yorichi) {
    ...
    try {
        ...
        const response = await fetch('https://raw.githubusercontent.com/Yorichi123qwx/Yorichi-game/refs/heads/main/%D8%AC%D9%8A%D9%86%D8%B4%D9%86.js');
...
handler.help = ['شخصية']; handler.tags = ['game']; handler.command = /^(جنشن|جينشن|قينشن|answer_\d+)$/i;
