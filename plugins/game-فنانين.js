...
if (!yorichi) {
    ...
    try {
        ...
        const response = await fetch('https://raw.githubusercontent.com/SungReved/games/refs/heads/main/Src/%D9%81%D9%86%D8%A7%D9%86%D9%8A%D9%86.json');
...
handler.help = ['شخصية']; handler.tags = ['game']; handler.command = /^(فنانين|فنان|answer_\d+)$/i;
