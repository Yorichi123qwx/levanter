...
if (!yorichi) {
    ...
    try {
        ...
        const response = await fetch('https://raw.githubusercontent.com/Yorichi123qwx/Yorichi-game/refs/heads/main/%D9%83%D9%88%D8%B1%D8%A9.js');
...
handler.help = ['شخصية']; handler.tags = ['game']; handler.command = /^(كورة|كوره|answer_\d+)$/i;
