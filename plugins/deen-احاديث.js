  ...
  try {
    ...
    for (let result of selectedResults) {
      results.push({
        ...
        footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "┊🍷⧼𝐒𝐏𝐈𝐃𝐄𝐑 𝐁𝐎𝐓⧽🍷┊" }), // ضع العلامة المائية هنا
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.fromObject({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({ text: '🔎 `احاديث`' }),
