import { webp2mp4 } from '../libraries/webp2mp4.js'
import { ffmpeg } from '../libraries/converter.js'
...
await conn.sendFile(m.chat, out, 'error.mp4', '*اتفضل طلبك يا حب🥰*', m, 0, { thumbnail: out })
}
