...
const connectionOptions = {
    ...
    mobile: MethodMobile,
    browser: opcion === '1' ? ['MVL-TEAM', 'Safari', '2.0.0'] : methodCodeQR ? ['MVL-TEAM', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
    auth: {
        creds: state.creds,
...
console.log(chalk.yellowBright.bold('┌「 Start with the country code of your WhatsApp number 」─────────┈ ⳹\n') + chalk.yellowBright.bold('│✑ Example : ') + chalk.white.bold('+201009480596\n') + chalk.yellowBright.bold('└─────────┈ ⳹\n\n'));
...
numeroTelefono = await question(chalk.yellowBright.bold('┌「 Add your number 」─────────┈ ⳹\n') + chalk.yellowBright.bold('│✑ Example : ') + chalk.white.bold('+201145624848\n') + chalk.yellowBright.bold('└─────────┈ ⳹\n\n'));
...
console.log(chalk.yellowBright.bold('┌「 Add your number 」─────────┈ ⳹\n') + chalk.yellowBright.bold('│✑ Example : ') + chalk.white.bold('+201145624848\n') + chalk.yellowBright.bold('└─────────┈ ⳹\n\n'));
