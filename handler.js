...
import { smsg } from './libraries/simple.js';
...
let addCap = `*╭────┄┄┄┄┄┄┄┄┄────╮*\n`;
 addCap += `*│✑ انا: ${wm}*\n\n`;
 addCap += `│✑ قناة بوت *اسبايدر* ...يتم نشر أكواد وإنشاء مسابقات بإستمرار..تستطيع الدخول عبر إستعمال الرابط في الأسفل↓↓\n`;
 addCap += `*├───┄┄┄┄┄┄┄┄┄┄┄───┤*\n`;
 addCap += `*│✑ لينك: https://whatsapp.com/channel/0029VascwNL60eBiGZOQz647\n`;
 addCap += `*╰────┄┄┄┄┄┄┄┄┄────╯*\n\n`;
 
let removeCap = `*╭────┄┄┄┄┄┄┄┄┄┄┄────╮*\n`;
 removeCap += `*│✑ أنا:SPIDER-BOT\n`;
 removeCap += `*│✑ قناة سبايدر بوت يتم نشر تحديثات بشكل مستمر عن البوت وغيره وأكواد برمجيه\n`;             
 removeCap += `*├───┄┄┄┄┄┄┄┄┄┄┄┄┄───┤*\n`;
 removeCap += `*│✑ لينك: https://whatsapp.com/channel/0029VascwNL60eBiGZOQz647\n`;
 removeCap += `*╰────┄┄┄┄┄┄┄┄┄┄┄────╯*\n\n`;
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        await mconn.conn.sendMessage(nk.from, { contacts: { displayName: 'Tᗴᗩᗰ ᗰᐯᒪ', contacts: [{ vcard }] } }, { quoted: callmsg });
...
*/
 ...
 global.dfail = (type, m, conn) => {
  ...
  const messages = {
    owner: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 الأمر ده للمطور فقط.*\n╰────┄┄┄┄┄┄┄┄────╯',
    rowner: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 الأمر ده خاص بالمطورين فقط.*\n╰────┄┄┄┄┄┄┄┄────╯',
    mods: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 الأمر ده خاص بالمساعدين فقط.*\n╰────┄┄┄┄┄┄┄┄────╯',
    premium: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 هذا الأمر للميزين فقط.*\n╰────┄┄┄┄┄┄┄┄────╯',
    group: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 الأمر ده للمجموعات فقط*\n╰────┄┄┄┄┄┄┄┄────╯',
    private: '╭────┄┄┄┄┄┄┄┄────╮\n│ *〄 الأمر ده للإستخدام في الخاص.*\n╰────┄┄┄┄┄┄┄┄────╯',
  ...
  const img2 = 'https://i.postimg.cc/GhmVLVqm/8c85cee14b9bb66e93c2e2214c0a3418.jpg';
    ...
    return conn.sendMessage(m.chat, {
      ...
      contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
              newsletterJid: '120363351206518144@newsletter',
              newsletterName: '◈🍷〘𝐘𝐎𝐑𝐈𝐂𝐇𝐈-𝐌𝐕𝐋〙🍷◈',
              serverMessageId: 100
          },
        externalAdReply: {
          ...
          mediaUrl: img2,
          mediaType: 1,
          sourceUrl: 'https://whatsapp.com/channel/0029VascwNL60eBiGZOQz647',
